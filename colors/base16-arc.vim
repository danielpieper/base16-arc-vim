" Base16 Arc (https://github.com/chriskempson/base16)
" Scheme: Daniel Pieper
...
if !has('gui_running')
  if exists("g:base16_shell_path")
    execute "silent !/bin/sh ".g:base16_shell_path."/base16-arc.".&background.".sh"
  endif
endif
